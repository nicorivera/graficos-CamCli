function btn_type(chart, root, series, data) {
  ...
  <div class="modal-type relative  w-full md:max-w-xl  md:w-[1000px] min-h-[400px]">   
      <div class=" ">
        ...
        <div id="content-modal-type" class="mt-4 md:mt-8 grid grid-cols-2 md:grid-cols-2 gap-1 md:gap-3">
...
`;
  ...
  function clearCheckboxes() {
    ...
    clearButton.addEventListener("click", function () {
      ...
      series.data.setAll([
        { country: "Argentina", year: data[0].year, children: [] },
      ]);
    });
  }
  //---------------------------------------------------------------------------------
  ...
  function addCheckboxes() {
    const container = document.getElementById("content-modal-type");
    const years = data[0].children.map((item) => item.name);
    years.forEach((year) => {
      ...
      checkbox.addEventListener("change", function () {
        ...
        let filteredData = data[0].children.filter((child) => {
          const childCheckbox = document.getElementById(child.name);
          return childCheckbox && childCheckbox.checked;
        });

        filteredData = [
          { country: "Argentina", year: data[0].year, children: filteredData },
        ];
